...
#hillshade {
  [class='shadow']{
    ...
    [level >= 50]{ polygon-fill: @cool1; }
    [level >= 60]{ polygon-fill: @cool2; }
    [level >= 70]{ polygon-fill: @cool3; }
    [level >= 80]{ polygon-fill: @cool4; }
    [level >= 90]{ polygon-fill: @cool5; }
    [level >= 94]{ polygon-fill: @cool6; }
  }
  [class='highlight']{
    [level >= 50]{ polygon-fill: @warm1; }
    [level >= 60]{ polygon-fill: @warm2; }
    [level >= 70]{ polygon-fill: @warm3; }
    [level >= 80]{ polygon-fill: @warm4; }
    [level >= 90]{ polygon-fill: @warm5; }
    [level >= 94]{ polygon-fill: @warm6; }
  }
}
